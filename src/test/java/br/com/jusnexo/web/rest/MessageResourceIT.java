...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().description(DEFAULT_DESCRIPTION).createdAt(DEFAULT_CREATED_AT);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
        return message;
    }
    ...
    void putNewMessage() throws Exception {
        ...
        updatedMessage.description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
