...
export const ClientDeleteDialog = (props: IClientDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jusnexoApp.client.delete.question">Are you sure you want to delete this Client?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-client" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
