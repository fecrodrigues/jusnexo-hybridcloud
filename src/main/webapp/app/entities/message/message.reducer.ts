...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_MESSAGE: 'message/PARTIAL_UPDATE_MESSAGE',
...
export default (state: MessageState = initialState, action): MessageState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_MESSAGE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_MESSAGE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_MESSAGE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IMessage> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_MESSAGE,
