...
/**
 * REST controller for managing {@link br.com.jusnexo.domain.Chat}.
 */
@RestController
@RequestMapping("/api")
public class ChatResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/chats/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<Chat>> getAllChats(
        ...
        Page<Chat> page;
        if (eagerload) {
            page = chatService.findAllWithEagerRelationships(pageable);
        } else {
